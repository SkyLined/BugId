...
dsId_uCode = {
  ...
  0x8007000E:                       "OOM",
  STATUS_NOT_IMPLEMENTED:           "PureCall",
  ...
  STATUS_ILLEGAL_INSTRUCTION:       "IllegalInstruction",
  ...
  STATUS_FLOAT_DIVIDE_BY_ZERO:      "FloatDivideByZero",
  ...
  STATUS_INTEGER_DIVIDE_BY_ZERO:    "IntegerDivideByZero",
  STATUS_INTEGER_OVERFLOW:          "IntegerOverflow",
  STATUS_PRIVILEGED_INSTRUCTION:    "PrivilegedInstruction",
  STATUS_STACK_OVERFLOW:            "StackExhaustion",
