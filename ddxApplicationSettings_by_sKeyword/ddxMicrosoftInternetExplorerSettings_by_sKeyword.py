...
dxConfigSettings = {
  ...
  "nExcessiveCPUUsageCheckInitialTimeoutInSeconds": 30.0, # Give browser some time to load repro
  "cBugId.nExcessiveCPUUsageCheckIntervalInSeconds": 30.0, # Browser may be busy for a bit, but no longer than 30 seconds.
  "cBugId.nExcessiveCPUUsagePercent": 95,      # Browser msust be very, very busy.
  "cBugId.nExcessiveCPUUsageWormRunTimeInSeconds": 0.5, # Any well written function should return within half a second IMHO.
